...
In this exercise, I realized that there were repeatitiion of tasks. So, I aimed at writing functions instead of flat out scripting approach. That way, I not only resued the same code over and over, but also built my own library of useful functions for later use. I saved time for future. So, I am happy to do this exericse.
